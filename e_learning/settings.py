...
SECRET_KEY = 'django-insecure-7p)89nk6)3kv$3woi!h!4!8h+)7&ra8e6h_-)05vo3h!#xh@7d'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "accounts/static_in_users", "static_files"),
